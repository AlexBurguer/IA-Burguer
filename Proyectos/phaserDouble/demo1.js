...
function preload(){
	...
	juego.load.image('bala', 'assets/sprites/purple_ball.png', 2, 2);
...
function disparo(){
	velocidadBala = -1 * velocidadRandom(150,200);
...
function disparoDos(){
	velocidadBalaDos = 1 * velocidadRandom(150,200);
